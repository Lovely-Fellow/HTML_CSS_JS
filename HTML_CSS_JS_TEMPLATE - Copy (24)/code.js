...
var animate = function () {
  ...
  function animateBlob() {
    var speed = 10;
    var tlBlob = new TimelineMax({
      repeat: -1
    });
    tlBlob.to(blob1, speed, {
      morphSVG: blob3,
  ...
  function makeConfetti() {
    var speed = 3;
    var confettiTl = new TimelineMax({
      paused: true
    });
  ...
  function willUnsubscribe() {
    ...
    TweenMax.to(paper, speed, {
      y: 15
    });
    TweenMax.to(eyeGroup, speed, {
      y: 5
    });
    TweenMax.to(mouth, speed, {
      y: 5
    });
